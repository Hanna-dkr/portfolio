...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const sections = document.querySelectorAll('.cg-section, .cg-section-special, #Objective, #Lessons');
  ...
  const sectionObserver = new IntersectionObserver(entries => {
    entries.forEach(entry => {
      ...
      const link = document.querySelector(".case-sidebar .side-button[href=\"#".concat(id, "\"]"));
  ...
  document.querySelectorAll('.case-sidebar .side-button').forEach(link => {
    link.addEventListener('click', e => {
      ...
      if (targetEl) {
        ...
        history.pushState(null, null, "#".concat(targetId));
      }
    });
  });
...
(function () {
  ...
  function update() {
    ...
    track.style.transform = "translateX(".concat(-index * perPage * w, "px)");
